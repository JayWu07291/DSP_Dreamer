...
FFV1 是目前優先候選。後續 [首次實機驗證](evidence/live-20260906T135528Z/review.md) 已通過 20 Hz、30 分鐘完整性與擷取數值門檻，影像 8.62 GiB、比相同幀數 raw 少 72.1%。RAM 缺測與 raw 對照尚待補齊，正式格式未決議，資料契約未修改。下方保留先前離線量測與當時的待辦。
