...
2026-09-17 後續更新：第九批第一回合已通過開局驗證，目前請依 [第九批核對報告](recording-batch9.md) 補同一批第二回合。原先直接連錄兩回合的安排已取代，下方保留第八批資料核對與第九批設定紀錄。
...
第九批第一回合已完成，目前請依 [第九批核對報告](recording-batch9.md) 的補錄指示。現有設定仍有效，無須重啟或重新校正。
