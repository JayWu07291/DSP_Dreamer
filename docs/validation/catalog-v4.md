...
第十八批、總整合及兩組共 15 題局部標註已完成，不需繼續錄製。Q05 已由使用者補充確認，左、右兩座熔爐均未建造完成；兩組共 8 個 UI 框也已確認。P001–P205 的描述與後續 10 段移動候選確認均已保存，合計 214 段完成分類，P085 仍待判定；累計移動 23、UI 63、建造／物品 64、等待 64。最新 10 段三項均經 Jay 確認，已編成完整候選片段。另從同一組三份 validation 來源讀取必要表格及 143 個原圖 chunk，檢視 48 組後提出 27 段移動建議，一頁集中待核對；若全部通過，移動分類達 50／50、完整候選達 37 段。原 400 題及補充搜尋的 947 個候選保留，沒有依代理預篩排除資料。其他類別的範圍與關鍵狀態尚待整理／確認，64 段 waiting 範圍建議仍為未確認。未重建語料、複製或重編影片，固定抽樣規則不變，見 [移動確認與補充覆核](movement-supplement-20260924.md)。
