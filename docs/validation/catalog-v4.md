...
後續第七批已核對完畢，並依使用者決定維持目前動作空間。最新單批報告與第八批設定見 [第七批錄製核對](recording-batch7.md)；最新完整總索引與收件方式見 [第五批錄製核對](recording-batch5.md)。
...
第七批已完成，後續按 [第七批核對報告](recording-batch7.md) 的第八批設定繼續。維持「電磁學完成 → 鐵礦採礦機 → 銅礦採礦機 → 冶金供料」的採礦優先安排，中後段依自然遊玩交錯進行，不必刻意等待。B／X 可正常使用，先前錄製不需重錄。
