...
後續第四批已核對完畢，並依使用者決定維持目前動作空間。最新索引與第五批設定見 [第四批錄製核對](recording-batch4.md)；[第三批紀錄](recording-batch3.md) 保留。
...
第四批已完成，後續按 [第四批核對報告](recording-batch4.md) 的第五批設定繼續。維持「電磁學完成 → 鐵礦採礦機 → 銅礦採礦機 → 冶金供料」的採礦優先安排，中後段依自然遊玩交錯進行，不必刻意等待。B／X 可正常使用，先前錄製不需重錄。
