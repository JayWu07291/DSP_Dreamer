...
後續第三批已核對完畢，並依使用者決定維持目前動作空間。最新索引與第四批設定見 [第三批錄製核對](recording-batch3.md)。
...
第三批已完成，後續按 [第三批核對報告](recording-batch3.md) 的第四批設定繼續。維持「電磁學完成 → 鐵礦採礦機 → 銅礦採礦機 → 冶金供料」的採礦優先安排，中後段依自然遊玩交錯進行，不必刻意等待。B／X 可正常使用，先前兩批不需重錄。
