...
2026-09-21 最新狀態：第十八批按 F8 因遊戲音量設定變更而拒絕開始，請先將音效音量恢復 95%、環境音效恢復 90%，套用後再按 F8。差異已精確核對，詳見 [指紋差異與恢復步驟](runtime-options-20260921.md)；不需重新校正，第十八批 seeds 保持原設定。
...
第十七批一回合已核對完畢，train 拆解達 20／20，train 與 validation 的 16 項任務正例配額均已滿。Offline-test 的最大任務缺口為 3 回，最新結果與第十八批三回合操作請依 [第十七批錄製核對](recording-batch17.md)。最新完整總索引與收件方式見 [第五批錄製核對](recording-batch5.md)。

第八批缺口原因見 [任務正例缺口診斷](coverage-diagnosis-batch8.md)。第十八批已依原順序切到 offline-test 組。沿用拆完登陸艙再開科技樹、磁線圈產出後再接通電路板線，並先供齊製造科技研究材料再完成熔爐自動供料接線。
...
第十七批已完成，接著依 [最新核對報告](recording-batch17.md) 錄第十八批三回合。前兩回成功後各按 F9，第三回成功後 F8 結束。收件後先確認 offline-test 剩餘任務缺口，再決定補錄或一次整合來源；目前不預先安排第十九批。
