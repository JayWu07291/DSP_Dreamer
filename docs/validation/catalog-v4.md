...
第十八批、總整合及兩組共 15 題局部標註已完成，不需繼續錄製。Q05 已由使用者補充確認，左、右兩座熔爐均未建造完成；兩組共 8 個 UI 框也已確認。P001–P205 的描述已保存，其中 204 段完成分類，P085 的取物時間不確定、分類待判定；累計移動 13、UI 63、建造／物品 64、等待 64。分類僅缺移動／視角 37 段。依使用者反映人工耗時，停止連續十題混合交付，尚未準備 P206–P215；後續先由代理預篩缺額類別，人工確認必要片段，原候選池與最終固定抽樣規則不變。範圍與關鍵狀態仍待確認，見 [第二十一批收件與人工工作調整](sequence-classification-196-205-20260924.md)。
