...
後續第九批第一回合已核對完畢，拆解新增有效正例。最新結果與同一批第二回合的操作請依 [第九批錄製核對](recording-batch9.md)。第八批資料與第九批設定來源見 [第八批錄製核對](recording-batch8.md)；最新完整總索引與收件方式見 [第五批錄製核對](recording-batch5.md)。

第八批缺口原因見 [任務正例缺口診斷](coverage-diagnosis-batch8.md)。第九批第一回合已驗證開局順序有效；下一回保留相同 seeds，維持拆完登陸艙再開科技樹，並先確認磁線圈自動產出再接通電路板產線。
...
第九批第一回合已完成，接著依 [第九批核對報告](recording-batch9.md) 補同一批第二回合。維持採礦優先安排及目前動作空間，成功後 F8 結束，不按 F9 連錄。先前錄製保留。
