...
第十三批已錄的兩回合均已核對完畢，拆解、熔爐接線與電路板產線各新增 2 回有效正例，矩陣科技供料的 train 配額已滿。現在只需補第三回合，操作請依 [第十三批前兩回合核對](recording-batch13.md)。最新完整總索引與收件方式見 [第五批錄製核對](recording-batch5.md)。

第八批缺口原因見 [任務正例缺口診斷](coverage-diagnosis-batch8.md)。目前維持第十三批 train 設定，尚未切到第十四批。沿用拆完登陸艙再開科技樹、磁線圈產出後再接通電路板線，並先供齊製造科技研究材料再完成熔爐自動供料接線。
...
第十三批前兩回合已保留，接著依 [本批核對報告](recording-batch13.md) 單獨補錄第三回合。F8 開始，一回成功後 F8 結束，這次不按 F9 接下一回。維持採礦優先安排及目前動作空間。
