...
第十一批三回合均已核對完畢，每回合的 16 項任務都有有效正例。最新結果與第十二批兩回合操作請依 [第十一批錄製核對](recording-batch11.md)。最新完整總索引與收件方式見 [第五批錄製核對](recording-batch5.md)。

第八批缺口原因見 [任務正例缺口診斷](coverage-diagnosis-batch8.md)。第十一批三回合已取得全部任務正例。第十二批已依原順序切到 validation 組，維持拆完登陸艙再開科技樹、磁線圈產出後再接通電路板線，並先供齊製造科技研究材料再完成熔爐自動供料接線。
...
第十一批已完成，接著依 [第十一批核對報告](recording-batch11.md) 錄第十二批兩回合。第一回成功後 F9，第二回成功後 F8 結束。維持採礦優先安排及目前動作空間，先前錄製保留。
