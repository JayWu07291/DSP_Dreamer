...
第十八批、總整合及第一組 10 題收件已完成，不需繼續錄製。下一步是在 `http://127.0.0.1:8831/` 完成 5 題游標、配方及建築連接問題；游標題已改為確認框選位置與清楚完整，不再要求描述朝向。逐題儲存後匯出 JSON 貼回對話，具體步驟見 [標註收件與下一組狀態題](guided-annotations-20260921.md)。
