...
第十六批四回合均已核對，第一、第二、第四回完整有效；第三回中途重載，但合法開局也取得拆解正例。Train 拆解已達 19／20，validation 任務配額全滿，offline-test 的最大任務缺口為 3 回。第十七批因此減為一回合，最新結果與操作請依 [第十六批四回合核對](recording-batch16.md)。最新完整總索引與收件方式見 [第五批錄製核對](recording-batch5.md)。

第八批缺口原因見 [任務正例缺口診斷](coverage-diagnosis-batch8.md)。第十七批已依原順序切到下一組 train seeds。沿用拆完登陸艙再開科技樹、磁線圈產出後再接通電路板線，並先供齊製造科技研究材料再完成熔爐自動供料接線。
...
第十六批已完成，接著依 [最新核對報告](recording-batch16.md) 錄第十七批一回合。F8 開始，一回成功後 F8 結束，這次不按 F9 接下一回。維持採礦優先安排及目前動作空間。
