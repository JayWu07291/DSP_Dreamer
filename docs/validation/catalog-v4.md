...
現在需要第三批兩個完整回合，無須再重啟或校正。按 F8 開始並等基準場景自動載入，完成第一回合後按 F9 重載，再完成第二回合，按 F8 結束並等發布完成。維持「電磁學完成 → 鐵礦採礦機 → 銅礦採礦機 → 冶金供料」的採礦優先安排，中後段依自然遊玩交錯進行，不必刻意等待。B／X 可正常使用，第二批兩回合不需重錄。
